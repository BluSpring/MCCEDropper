...
object LevelFinishRemoveCommand : CommandExecutor {
    override fun run(sender: CommandSender, args: Array<out Any>) {
        ...
        level.finishPoints.removeAt(args[1] as Int)

        LevelManager.save()

        sender.sendMessage("${ChatColor.GREEN}Successfully removed finishing area!")
    }
}