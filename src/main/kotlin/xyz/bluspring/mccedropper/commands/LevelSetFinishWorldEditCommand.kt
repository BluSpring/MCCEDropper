...
object LevelSetFinishWorldEditCommand : CommandExecutor {
    override fun run(sender: CommandSender, args: Array<out Any>) {
        ...
        try {
            ...
            level.finishPoints.add(listOf(
                Location(BukkitAdapter.adapt(selection.world), selection.minimumPoint.blockX.toDouble(), selection.minimumPoint.blockY.toDouble(), selection.minimumPoint.blockZ.toDouble()),
                Location(BukkitAdapter.adapt(selection.world), selection.maximumPoint.blockX.toDouble(), selection.maximumPoint.blockY.toDouble(), selection.maximumPoint.blockZ.toDouble())
            ))
